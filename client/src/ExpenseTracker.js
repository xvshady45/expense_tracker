...
const ExpenseTracker = () => {
    ...
    // Save Transactions to Local Storage whenever transactions update
    useEffect(() => {
        ...
        <div className={`container ${darkMode ? 'dark' : ''}`}>
            ...
            <div className="add-transaction">
                ...
                <form onSubmit={(e) => e.preventDefault()}>
                    ...
                    <button type="button" onClick={addTransaction} disabled={!description || !amount || !date}>Add Transaction</button>
                </form>
            </div>
        </div>
    );
